...
init_data =scipy.io.loadmat('Final_train_nor_input_data_models_2.mat')['Final_input_data']       # 原始特徵數據(維度:樣本*特徵)
label = scipy.io.loadmat('Final_train_nor_output_data_models_2.mat')['Final_output_data']*1000          # 特徵數據之對應標籤(維度:樣本*1)

test_input_data =  scipy.io.loadmat('Final_test_nor_input_data_models_2.mat')['Final_input_data']
test_output_data = scipy.io.loadmat('Final_test_nor_output_data_models_2.mat')['Final_output_data']*1000
...
gkf = GroupKFold(n_splits=12)     #設定 GroupKFold 交叉驗證模組
...
# 儲存最佳解為 .mat 文件
scipy.io.savemat('best_solution_models_2.mat', {'solution': solution})

# 儲存最佳超參數和選擇特徵為 CSV 文件
model_name = 'models_2'  # 根據檔案名自動設定模型名稱
