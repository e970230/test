...
# Load Data
#-------------------------------------------------------------------------------------
# input_data_models_1_F_10000
#x_train = scipy.io.loadmat(f'input_data_models_1_F_10000.mat')['train_input_data']
#-------------------------------------------------------------------------------------

x_train = scipy.io.loadmat(f'input_data_models_1_dlp_20_F_10000.mat')['Final_input_data']
...
test_predictions = model_1.predict(generated_data)
