...
actor = [
    ...
    fullyConnectedLayer(128, 'Name', 'fc1', 'WeightsInitializer', 'glorot', 'BiasInitializer', 'zeros')
    reluLayer('Name', 'relu1')
    fullyConnectedLayer(64, 'Name', 'fc2', 'WeightsInitializer', 'glorot', 'BiasInitializer', 'zeros')
